	...
	return (
        ...
        <header className="w3l-header-nav">
            <nav className="navbar navbar-expand-lg navbar-light px-lg-0 py-0 px-3 stroke">
                <div className="container">
                    <NavLink className="navbar-brand" to="/admin/medications"><span>Utibu</span>Health</NavLink>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mx-lg-auto">
                            <li className="nav-item">
                                <NavLink className="nav-link" to="/admin/medications">Medications</NavLink>  {/* Update to "/admin/medications" */}
                            </li>
                            <li className="nav-item">
                                <NavLink className="nav-link" to="/admin/orders">Orders</NavLink>  {/* Keep "/admin/orders" */}
                            </li>                            
                        </ul>
                        {/* search-right */}
